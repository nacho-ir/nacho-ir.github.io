            ...
            <form id="dataFRM" action="ProcesoPersonasDEL.php" method="POST">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo "<input id='dataNOM' type='text' name='NOM' value='$nombre' disabled />";
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo "<input id='dataDIR' type='text' name='DIR' value='$direccion' disabled/>";
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo "<input id='dataTEL' type='text' name='TEL' value='$telefono' disabled/>";
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo "<input id='dataDTO' type='text' name='DTO' value='$departamento' disabled/>"
                            ?>
                        </td>
                    </tr> 
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="button" value="Eliminar datos" onclick="ConfirmDEL();"/>
                            <input type="button"  value="Cancelar" onclick="SetPage('FormPersonasDEL.html');" />
                        </td>
                    </tr>                    
                </table>
            </form>
